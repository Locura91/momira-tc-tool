...
st.caption("Build version: 2026-07-28-image-dedup-and-visual-picker — bump this string whenever new code is shared, so it's always obvious whether a deploy actually took effect.")

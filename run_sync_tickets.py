...
import json
import argparse
# BUGFIX (found while merging this repo into the Momira Travel Platform): List/Dict/Any are
# used in sync_all_tickets()'s annotations below but were never imported, so this script died
# with "NameError: name 'List' is not defined" the moment it was run or imported - it was
# broken for every invocation, not just an edge case. The other run_sync_* scripts don't have
# this problem; only this one used typing generics without importing them.

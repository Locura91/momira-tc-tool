...
st.caption("Build version: 2026-08-09-no-empty-escape — bump this string whenever new code is shared, so it's always obvious whether a deploy actually took effect.")
